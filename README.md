...
A versatile Informatics Engineering undergraduate bridging the gap between modern full-stack web engineering, applied artificial intelligence, agentic developer workflows, and system security. Experienced in engineering high-performance web applications using modern JavaScript/TypeScript, PHP & Laravel, and relational database architectures. Deeply engaged in practical offensive and defensive cyber security, vulnerability assessment, and Capture The Flag (CTF) competitions. Leverages next-generation agentic AI tools to build scalable, clean, and secure software architectures.
...
#### 3. Modern AI, LLM & Agentic Developer Tools
...
[![Claude Code](https://img.shields.io/badge/Claude_Code-Anthropic-D97706?style=flat&logo=anthropic&logoColor=white)](https://anthropic.com/)
[![Codex](https://img.shields.io/badge/Codex-OpenAI-412991?style=flat&logo=openai&logoColor=white)](https://openai.com/)
...
#### 4. Operating Systems, DevOps & Containers
...
#### 5. Cyber Security & Defensive Engineering
...
[![OWASP](https://img.shields.io/badge/Security-OWASP_Top_10-000000?style=flat&logo=owasp&logoColor=white)](https://owasp.org/)
[![Secure Coding](https://img.shields.io/badge/SecDev-Secure_Coding_Practices-success?style=flat)](https://github.com/BagaskaraAP-Dev)
...
- **Cyber Security Competitor & Practitioner**  
  *Team Martabak Manis (2025 - Present)*
  - Actively competing in national and regional Capture The Flag (CTF) events.
  - Analyzing web application vulnerabilities, testing threat vectors, and applying Blue Team defensive methodologies to secure infrastructure.
